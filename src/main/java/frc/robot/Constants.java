...
public class Constants {
    ...
    public class Hood {
        ...
        public static final double THETA_ANGLE_FROM_SHOOTER = 104; //this is measured angled which the ball exits the shooter
    ...
    public class Shooter {
        public static final double POWER_GAIN_MULTIPLIER = 2.03;
    }
