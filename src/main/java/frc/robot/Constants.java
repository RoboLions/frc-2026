...
public class Constants {
    ...
    public class Hood {
        ...
        public static final double THETA_ANGLE_FROM_SHOOTER = 101.0; //this is measured angled which the ball exits the shooter
        ...
        public static final double YAW_COMPENSATION_LATENCY_MS = 0.0;

        public static final double HEIGHT_FROM_BOT_TO_TARGET = 1.117; //meters
        public static final Translation2d TURRET_ROBOT_OFFSET = new Translation2d(0.16, -0.14605); //meters
