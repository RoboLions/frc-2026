...
public class Constants {
    ...
    public class Hood {
        ...
        public static final double THETA_ANGLE_FROM_SHOOTER = 103.75; //this is measured angled which the ball exits the shooter
        ...
        public static final Translation2d TURRET_ROBOT_OFFSET = new Translation2d(0.1575, -0.14605); //meters
    ...
    public class Shooter {
        public static final double POWER_GAIN_MULTIPLIER = 2.0125;
    }
