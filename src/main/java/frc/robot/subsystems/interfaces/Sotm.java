...
static {
    ...
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(1.70, 0.800));
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(2.09, 0.839));
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(2.51, 0.871));
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(3.00, 0.910));
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(3.50, 0.950));
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(3.81, 0.975));
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(4.20, 1.006));
    TIME_OF_FLIGHT_LOOKUP_TABLE.add(new TimeOfFlightPoint(4.50, 1.030));
}
