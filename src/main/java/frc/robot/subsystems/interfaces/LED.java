...
public class LED {
  ...
  public static void setRainBow() {
    mRGB_Candle.setControl(
        new RainbowAnimation(0, MAX_LED_INDEX).withFrameRate(100).withBrightness(0.25));
  }

  public static void setSolidGreen() {
    mRGB_Candle.setControl(new SolidColor(0, MAX_LED_INDEX).withColor(new RGBWColor(0, 255, 0)));
  }

  public static void setSolidBlue() {
    mRGB_Candle.setControl(new SolidColor(0, MAX_LED_INDEX).withColor(new RGBWColor(0, 0, 255)));
  }

  public static void setSolidRed() {
    mRGB_Candle.setControl(new SolidColor(0, MAX_LED_INDEX).withColor(new RGBWColor(255, 0, 0)));
  }

  public static void setFlashGreen() {
    mRGB_Candle.setControl(
        new StrobeAnimation(0, MAX_LED_INDEX).withColor(new RGBWColor(0, 255, 0)));
  }

  public static void setSolidWhite() {
    mRGB_Candle.setControl(
        new SolidColor(0, MAX_LED_INDEX).withColor(new RGBWColor(255, 255, 255)));
  }

  public static void setFlashBlue() {
    mRGB_Candle.setControl(
        new StrobeAnimation(0, MAX_LED_INDEX)
  ...
  public static void setLarsonWhite() {
    mRGB_Candle.setControl(
        new LarsonAnimation(0, MAX_LED_INDEX)
            .withColor(new RGBWColor(255, 255, 255))
            .withSize(15)
            .withFrameRate(50));
  }
  ...
  public static void turnOff() {
    ...
    mRGB_Candle.setControl(new SolidColor(0, MAX_LED_INDEX).withColor(new RGBWColor(0, 0, 0)));
  }
}
