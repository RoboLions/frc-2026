...
public class Hood {
    ...
    private static class TurretState {
      private static Rotation2d goalAngle = Rotation2d.kZero;
      ...
      private static double goalDegrees = 0.0;
    }
  ...
  */
                                         ...
                                         double robotYawRate) 
  {
    ...
    SimulationObjects.desiredTurretAngleFieldRel = Math.atan2(dy, dx) - robotFieldYaw + totalLeadOffsets;
    SimulationObjects.simulationTurretController.setSetpoint(SimulationObjects.desiredTurretAngleFieldRel);

    SimulationObjects.simulationTurretAngle += SimulationObjects.simulationTurretController.calculate(SimulationObjects.simulationTurretAngle);
    Logger.recordOutput("Turret 3D Pose", new Pose3d(0, 0, 0, new Rotation3d(0 , 0, SimulationObjects.simulationTurretAngle)));
  }
}